...
function Review_04() {
  ...
  return (
    <div className="items-left flex w-full flex-col gap-6 px-6 py-4">
      <h1 className="mb-4 text-left text-2xl font-semibold md:text-center">
        Customer Reviews
      </h1>
      <div className="flex flex-row flex-wrap gap-12">
        <div className="flex grow-0 flex-col justify-around gap-2">
          <p className="text-4xl font-semibold"> {rating}/5</p>
          <StarRating value={rating} readOnly iconSize={36} />
