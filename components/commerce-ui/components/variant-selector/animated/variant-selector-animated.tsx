    ...
    >
      ...
      {variants.map((variant) => (
        <label
          ...
          className="has-focus-visible:outline-ring/70 relative flex min-w-[4rem] cursor-pointer flex-col items-center gap-2 rounded-lg px-2.5 py-2 text-center shadow-xs shadow-black/5 outline-offset-2 transition-colors has-focus-visible:outline has-data-disabled:cursor-not-allowed has-data-disabled:opacity-50 sm:min-w-[5rem] sm:gap-3 sm:px-4 sm:py-3"
        >
          ...
          <motion.p className="text-foreground text-sm leading-none font-medium whitespace-nowrap">
            {variant.label}
          </motion.p>
        </label>
      ))}
