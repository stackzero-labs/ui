...
<Tabs items={["pnpm", "npm", "bun"]}>
    ```bash tab="pnpm"
    pnpm dlx shadcn@latest add https://ui.stackzero.co/r/product-card-01-block.json
    ```
    ```bash tab="npm"
    npx shadcn@latest add https://ui.stackzero.co/r/product-card-01-block.json
    ```
    ```bash tab="bun"
    bun x --bun shadcn@latest add https://ui.stackzero.co/r/product-card-01-block.json
    ```
</Tabs>
...
<Tabs items={["pnpm", "npm", "bun"]}>
    ...
    ```
    ```bash tab="npm"
    npx shadcn@latest add https://ui.stackzero.co/r/product-card-01-block.json -c ./apps/www
    ```
    ```bash tab="bun"
    bun x --bun shadcn@latest add https://ui.stackzero.co/r/product-card-01-block.json -c ./apps/www
    ```
</Tabs>
